...
const Util::StringHash Behave::Components::BehaviourTreeComponentInfo::sk_typeHash =
	Util::CalcHash(BehaviourTreeComponentInfo::sk_typeName);

Mem::UniquePtr<Behave::ActorComponentInfo> Behave::Components::BehaviourTreeComponentInfo::LoadFromJSON(
