...
void ECS::ActorInfoManager::LoadActorInfosInDirectory(const File::Path& directory)
{
...
const ECS::ActorInfo* ECS::ActorInfoManager::FindActorInfo(const Util::StringHash actorInfoNameHash) const
{
