...
inline Variant<Types...>::~Variant()
{
	// A parameter pack expansion does not correctly expand a destructor call,
	// so instead the desctructor call is generated by moving the data into a temporary.
	// TODO(bug) this does not actually generate a destructor call...
	Match([](Types& data) { Types moved = std::move(data); }...);
}
